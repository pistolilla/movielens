...
$.getMovies = function() {
    ...
    $.ajax({
        ...
        url: 'https://pistolilla.pythonanywhere.com/movielens/api/movies', data: body})
...
$(function() {
    ...
    // populate genres
    $.getJSON("https://pistolilla.pythonanywhere.com/movielens/api/genres")
    .done(function(result) {
        // iterating through results
    ...
    $("#recommendbtn").click(function() {
        ...
        $.ajax({
            type: 'POST', contentType: "application/json", dataType: 'json',
            url: 'https://pistolilla.pythonanywhere.com/movielens/api/recommendations', data: body})
        .done(function(result) {
